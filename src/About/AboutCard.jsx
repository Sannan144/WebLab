...
>
  ...
  ></div>
  <div
    className="absolute blur duration-500 group-hover:blur-none w-12 h-12 rounded-full group-hover:translate-x-12 group-hover:translate-y-2 bg-black right-12 bottom-12"
  ></div>
  <div
    className="absolute blur duration-500 group-hover:blur-none w-36 h-36 rounded-full group-hover:translate-x-12 group-hover:-translate-y-12 bg-[#222] right-1 -top-0"
  ></div>
  <div
    className="absolute blur duration-500 group-hover:blur-none w-24 h-24 bg-[#22bf66] rounded-full group-hover:-translate-x-12"
  ></div>
